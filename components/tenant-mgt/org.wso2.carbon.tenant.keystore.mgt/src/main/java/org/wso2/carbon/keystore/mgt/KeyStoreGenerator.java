...
public class KeyStoreGenerator {
    ...
    private X509Certificate generateKeyPair(KeyStore keyStore) throws KeyStoreMgtException {
        try {
            ...
            JcaX509v3CertificateBuilder v3CertBuilder = new JcaX509v3CertificateBuilder(new X500Name(commonName),
                    BigInteger.valueOf(new SecureRandom().nextInt()),
                    notBefore, notAfter, new X500Name(commonName), keyPair.getPublic());
